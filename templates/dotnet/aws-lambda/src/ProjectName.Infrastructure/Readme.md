...
WORKDIR /src
COPY ["ProjectName.Presentation.csproj", "ProjectName.Presentation/"]
RUN dotnet restore "ProjectName.Presentation/ProjectName.Presentation.csproj"

WORKDIR "/src/ProjectName.Presentation"
COPY . .
RUN dotnet build "ProjectName.Presentation.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "ProjectName.Presentation.csproj" \
...
Execute unit tests
```
    cd "ProjectName.Presentation/test/ProjectName.Presentation.Tests"
    dotnet test
```

Deploy application
```
    cd "ProjectName.Presentation/src/ProjectName.Presentation"
